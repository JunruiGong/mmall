...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> selectQuestion(String username) {
        ...
        return ServerResponse.createByErrorMessage("找不到密码提示问题。");
    }
    ...
    public ServerResponse<String> forgetRestPassword(String username, String passwordNew, String forgetToken) {
        ...
        if (StringUtils.equals(forgetToken, token)) {
            String med5Password = MD5Util.MD5EncodeUtf8(passwordNew);

            int rowCount = userMapper.updatePasswordByUsername(username, med5Password);
    ...
    public ServerResponse<String> resetPassword(String passwordOld, String passwordNew, User user) {
        ...
        // 因为我们会查询出一个count(1)，如果不指定id，那么结果就是true，count>0
    ...
    public ServerResponse<User> updateInfo(User user) {
        //username 不能更新
        //Email校验，校验新的email是否存在，并且存在的email如果相同的话，不能是我们当前这个用户的。
